...
class Solution {
    public String[] findWords(String[] words) {
        ...
        for (String word : words) {
            ...
            if (canUseSingleRow(lower, row1) ||
                canUseSingleRow(lower, row2) ||
                canUseSingleRow(lower, row3)) {
                result.add(word);
            }
        }
    ...
    private boolean canUseSingleRow(String word, Set<Character> row) {
